...
--     id SERIAL PRIMARY KEY,
--     album_name TEXT,
--     album_owner INT REFERENCES users(id) ON DELETE SET NULL,
--     created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
-- );
...
--     id SERIAL PRIMARY KEY,
--     picture TEXT,
--     album INT REFERENCES albums(id) ON DELETE SET NULL,
...
--     id SERIAL PRIMARY KEY,
--     img_id INT REFERENCES pictures (id) ON DELETE SET NULL,
...
--     id SERIAL PRIMARY KEY,
--     user_img INT REFERENCES pictures(id) ON DELETE SET NULL,
--     user_profile INT REFERENCES users(id) ON DELETE SET NULL
-- );
